...
export function Button({ variant = "primary", className, children, ...props }: ButtonProps) {
  return (
    <button
      className={cn(
        "inline-flex min-h-[44px] items-center justify-center gap-2 rounded-button px-6 text-ui-label font-medium tracking-wide transition-colors duration-ui ease-premium disabled:pointer-events-none disabled:opacity-40",
        variant === "primary" &&
